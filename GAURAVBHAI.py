...
# ===== CONFIGURATION =====
BOT_TOKEN = "8878650472:AAFare6h41bX_JFW5rz5GSE8DmqhgS8aMlY"   # <-- Updated
MONGO_URL = "mongodb+srv://gb824083_db_user:chzG3YUsv2Z7ukmx@gauravxddos.ajue9og.mongodb.net/?appName=GAURAVXDDOS"   # <-- Updated
...
print(f"🌐 API: https://god.godstress.site")
print(f"🔑 API Key: nk_cf1f47c8a0a31abb849e4d3b6bbf2f54")
