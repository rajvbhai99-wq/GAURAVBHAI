...
MONGO_URL = os.getenv("mongodb+srv://bobby84888_db_user:laS6C0qE0AWKrbUP@bobbymaster.cnk9aei.mongodb.net/?appName=BOBBYMASTER")
...
# ===== PRIVATE CHANNEL (JOIN REQUIRED, NO KEY NEEDED) =====
PRIVATE_CHANNEL_LINK = "https://t.me/+l-KkkktXzy1jMDll"
...
# ===== API LIST - SLOTS (UPPERCASE SLOT PARAM) =====
...
# ===== CHANNEL JOIN REQUIRED (ALWAYS ON) =====
...
# ===== CHANNEL JOIN CHECK (private channel – NO KEY NEEDED) =====
...
def handle_attack(message):
    ...
    if is_group:
        if not check_group_approval(message):
            return
    # Private chat: NO KEY NEEDED — only channel join required (checked below)
